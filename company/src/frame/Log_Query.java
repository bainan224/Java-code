...
public class Log_Query 
{
	...
	private String tableTitle[]={"日志类型", "操作时间","操作用户","操作事物","操作数量","其他信息"};
	...
	private void initialize() 
	{
		...
		comboBox.addItem("部门修改");
		comboBox.addItem("部门添加");
		comboBox.addItem("部门销售");
		
		comboBox.addItem("员工添加");
		comboBox.addItem("员工修改");
		comboBox.addItem("员工删除");
		comboBox.addItem("职位积分");
		
		comboBox.addItem("工资卡添加");
		comboBox.addItem("工资卡删除");
		comboBox.addItem("工资卡使用");
