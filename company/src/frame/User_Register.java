...
public class User_Register implements ActionListener {
	...
	private void initialize() {
		...
		panel.setBorder(new TitledBorder(null, "人事系统注册", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		comboBox_1.setModel(new DefaultComboBoxModel(new String[] {"员工", "管理员"}));
