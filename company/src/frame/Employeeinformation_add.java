...
public class Employeeinformation_add implements ActionListener {
	 ...
	 */
	public Employeeinformation_add() {
		initialize();
	...
	private void initialize() {
		...
		panel.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "添加员工", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		btnenter.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) 
			{
				...
				{
					employeeinformation vip = new employeeinformation(textField.getText(),textField_1.getText(),textField_2.getText(),0,textField_3.getText(),new Date());
					vipmysql.add(vip);
					Unit.putDebug(vip);
					JOptionPane.showMessageDialog(null,"注册员工信息成功！","消息提示", JOptionPane.INFORMATION_MESSAGE);					
