...
public class employeeinformation_Query {

	private JFrame frame;
	private JTextField textField;
	private JTable table;
	private DefaultTableModel DTM;
	private String tableTitle[]={"员工ID", "员工部门","员工姓名","职位积分","联系方式","注册日期"};

	private employeeinformationimpl vipmysql = new employeeinformationimpl();
	/**
	 * Create the application.
	 */
	public employeeinformation_Query() {
		initialize();
	...
	private void initialize() {
		...
		panel.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "信息查询", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		JLabel lblid = new JLabel("请输入员工ID：");
		...
		button.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				else
				{
					try
					{
						employeeinformation temp=vipmysql.getById(textField.getText());
					...
					{
						JOptionPane.showMessageDialog(null,"无此员工ID！","消息提示", JOptionPane.INFORMATION_MESSAGE);
					}
				}
			}
		});
