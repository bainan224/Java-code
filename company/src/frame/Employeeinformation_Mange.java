...
public class Employeeinformation_Mange implements TableModelListener {
	 ...
	 */
	public Employeeinformation_Mange() {
		initialize();
	...
	public void tableChanged(TableModelEvent e)
	{
		...
		if(row!=-1)
		{
			...
			employeeinformation vip = new employeeinformation(id,user,name,count,telephone,null);
			try
			{
				employeeinformationimpl.update(vip);
