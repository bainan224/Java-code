...
public class VIP {
	public static void main(String[] args) {
		...
		tf1 = new JTextField("20070305001");
		tf2 = new JTextField("刘福贵");
		tf3 = new JTextField("女");
		tf4 = new JTextField("0635-567890");
		tf5 = new JTextField("普通会员");
		tf6 = new JTextField("0.8");
		tf7 = new JTextField("上海运输公司");
